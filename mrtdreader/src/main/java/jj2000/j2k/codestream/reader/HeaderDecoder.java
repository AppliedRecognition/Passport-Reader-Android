 ...
 * CVS identifier:
 *
 * $Id: HeaderDecoder.java 169 2012-01-15 18:33:24Z mroland $
 *
 * Class:                   HeaderDecoder
 *
...
import jj2000.colorspace.ChannelDefinitionMapper;
import jj2000.colorspace.ColorSpace;
import jj2000.colorspace.ColorSpaceException;
import jj2000.colorspace.ColorSpaceMapper;
import jj2000.colorspace.PalettizedColorSpaceMapper;
import jj2000.colorspace.Resampler;
...
public class HeaderDecoder implements ProgressionType, Markers,
    ...
    public EntropyDecoder createEntropyDecoder(CodedCBlkDataSrcDec src,
        ...
        return new StdEntropyDecoder(src,decSpec,doer,false,mMax);
